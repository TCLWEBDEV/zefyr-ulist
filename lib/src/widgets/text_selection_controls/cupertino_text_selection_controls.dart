...
import 'zefyr_text_selection_controls.dart';
import 'zefyr_text_selection_delegate.dart';
...
class _CupertinoTextSelectionControlsToolbar extends StatefulWidget {
  ...
  final VoidCallback? handleOpenLink;
...
class _CupertinoTextSelectionControlsToolbarState
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.handleOpenLink != null) {
      addToolbarButton("Open", widget.handleOpenLink!);
    }
...
class CupertinoTextSelectionControls extends ZefyrTextSelectionControls {
  ...
  Widget buildToolbar(
    ...
    /// Need to be a ZefyrTextSelectionDelegate
    ...
    return _CupertinoTextSelectionControlsToolbar(
      ...
      handleOpenLink: delegate is ZefyrTextSelectionDelegate
          ? canOpenLink(delegate)
              ? () => handleOpenLink(delegate)
              : null
          : null,
